...
summary: "Learn JavaScript Fetch API by building a simple application"
image: "https://ogsupa.com/api/v1?title=JavaScript+Fetch+API&description=Learn+JavaScript+Fetch+API+by+building+a+simple+application&background_color=%23f9d423&font_style=font-sans&left_meta=17th+June+%E2%80%A2+6min&right_meta=zaidmkz.xyz"
---
...
[source code on codepen](https://codepen.io/zaidmukaddam/pen/zYRbQKQ) . Now let's take
...
<Image src={"/static/images/javascript-fetch-api/overview.png"} alt='Overview' width={884 / 1.2} height={504 / 1.2} />
...
<Image src={"/static/images/javascript-fetch-api/working.gif"} alt='working' width={884 / 1.2} height={504 / 1.2} />
...
[final source code Codepen](https://codepen.io/zaidmukaddam/pen/zYRbQKQ).
